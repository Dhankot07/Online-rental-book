                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-square" id="squareInput"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-pill" id="pillInput"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control input-solid" id="solidInput"
