                                    ...
                                    <div class="row">
                                        <div class="col-lg-11">
                                            ...
                                            <?php
                                                ...
                                                $update_query=mysqli_query($con,"UPDATE book_order SET is_deleted='1' WHERE user_id='$user_id' AND ending_date='$current_date'");
                                                
                                                $query=mysqli_query($con,"SELECT * FROM book_order bo JOIN book_list bl ON bo.b_id = bl.book_id  WHERE bo.user_id='$user_id' AND bo.is_deleted='0'");
                                                $count=mysqli_num_rows($query);
                                            ?>
                                            <div class="d-flex justify-content-between align-items-center mb-4">
                                                <div>
                                                    <p class="mb-1">E-Book Bag</p>
                                                    <p class="mb-0">You have <?= $count ?> book in your bag.</p>
                                                </div>
                                                <!--<div>
                                                        ...
                                                        <div class="d-flex justify-content-between">
                                                            <div class="d-flex flex-row align-items-center col-md-4">
                                                                ...
                                                                <div class="col-md-8">
                                                                    ...
                                                                    <p class="small mb-0"><?= $row['book_author'] ?></p>
                                                                </div>
                                                            </div>
                                                            <div class="d-flex flex-row align-items-center col-md-4">
                                                                <div style="width: 120px;">
                                                                    ...
                                                                    <h5 class="mb-1">
                                                                        <?php
                                                                            echo $row['ending_date'];
                                                                        ?>
                                                                    </h5>
                                                                </div>
                                                            </div>
                                                            <div class="d-flex flex-row align-items-center">
                                                                <a onclick="location.href='return_book.php?id=<?php echo $row['book_id']; ?>' "
